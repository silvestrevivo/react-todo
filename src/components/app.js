  ...
  render () {
    ...
    return (
      <div className="container">
        ...
        <form className="form-inline text-center" onSubmit={e => this.handleClick(e)} ref={input => { this.addForm = input }}>
          <div className="form-group">
            <label className="sr-olny" htmlFor="newItemInput">Add new Item</label>
            <input type="text" placeholder="Bread" className="form-control" id="newItemInput" ref={input => { this.newItem = input }} />
            ...
            <tfoot>
              <tr>
                <td colSpan="3" className="text-center">
                  <button className="btn btn-large btn-primary" onClick={() => this.clearList()}>
                    Clear list
                  </button>
                </td>
              </tr>
